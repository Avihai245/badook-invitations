# Sahar Bordeaux · סהר בורדו (`sahar-bordeaux`)

מעטפת שנהב עם חותם שעווה בורדו, שקיעה בצבעי מים מעל כרמים ואיורי דיו בגוון ספיה. קלאסי, חם ורומנטי.

Cover: `envelope_seal` · overlay `wax_seal` · exit `crack` · categories: wedding, engagement, save_the_date

Upload them to the Supabase Storage bucket `template-media`, folder `sahar-bordeaux/`, then run `npm run media:sync` (docs/template-media.md). Prompts: see invitation-templates-kit-he.md §5.
...
| [ ] `rings-vine.webp` | transparent WebP ≤120KB | template:rings-vine |
| [ ] `bicycle.webp` | transparent WebP ≤120KB | template:bicycle |
| [ ] `harvest-table.webp` | transparent WebP ≤120KB | template:harvest-table |
