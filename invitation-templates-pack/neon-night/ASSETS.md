...
Upload them to the Supabase Storage bucket `template-media`, folder `neon-night/`, then run `npm run media:sync` (docs/template-media.md). Prompts: see invitation-templates-kit-he.md §5.
